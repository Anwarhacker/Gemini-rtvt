      ...
      <div className="flex-1 bg-slate-900 flex flex-col items-center justify-center relative border-b border-slate-800 p-4">
        ...
        <div className="absolute top-4 right-4 flex gap-3 z-20">
          <button
            ...
            className="w-12 h-12 rounded-full flex items-center justify-center transition-all shadow-xl bg-red-900/20 hover:bg-red-900/40 text-red-300 border border-red-900/30"
            title="Reset History"
          >
